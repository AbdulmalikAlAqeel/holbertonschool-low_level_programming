Task 0: The function int _isupper(int c) takes an integer (character) as an input and determines if it falls within the range of uppercase letters ('A' through 'Z') in the ASCII table.
Task 1: The function int _isdigit(int c) checks if the input character c is a digit from 0 through 9.
Task 2: he function `int mul(int a, int b)` takes two integers and returns their product.
